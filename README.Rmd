...
Statistical Rethinking [Richard McElreath] 2nd Edition chapter notes and solutions in R. 
...
for(i in seq_along(chapters)){
     num <- str_extract(chapters[i], "\\d+")
     files <- list.files(chapters[i], include.dirs = FALSE, full.names = TRUE)
     note <- grep("Chapter_\\d+\\.(R|Rmd)$", files, value = TRUE)
